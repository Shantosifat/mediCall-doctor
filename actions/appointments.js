  ...
  try {
    ...
    const existingAppointments = await db.appointment.findMany({
      where: {
        ...
        status: "SCHEDULED",
        startTime: {
          lte: lastDay, // lte = less than or equal
        },
      },
    });
    ...
    for (const day of days) {
      ...
      availableSlotsByDay[dayString] = []; //   available slots will be added to this array
        ...
        OR: [
          {
            ...
            startTime: {
              lte: startTime, //   lte = less then or equal
            },
            endTime: {
              gt: startTime, //   gt = greater then
            },
          },
          {
            // New appointment ends during an existing appointment
            startTime: {
              lt: endTime, //   lt = less then
            },
            endTime: {
              gte: endTime, //   gte = greater then or equal
            },
          },
          {
            // New appointment completely overlaps an existing appointment
            startTime: {
              gte: startTime, //   gte = greater then or equal
            },
            endTime: {
              lte: endTime, //   lte = less then or equal
            },
          },
        ],
      },
